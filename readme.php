...
Thanks for visiting [The Markdown Guide](git@github.com:yayacill/yaya-project.git)!

This Markdown cheat sheet provides a quick overview of all the Markdown syntax elements. It can’t cover every edge case,
so if you need more information about any of these elements, refer to the reference guides for [basic
syntax](git@github.com:yayacill/yaya-project.git) and [extended syntax](git@github.com:yayacill/yaya-project.git).
...
(git@github.com:yayacill/yaya-project.git)
